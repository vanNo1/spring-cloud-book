...
public class RedisPool {
    ...
    private static Boolean testOnBorrow = Boolean.parseBoolean(PropertiesUtil.getPropertity("redis.test.borrow"));
    //whether test when borrow a jedis if true then it's available
    private static Boolean testOnReturn = Boolean.parseBoolean(PropertiesUtil.getPropertity("redis.test.return"));
    //whether test when return a jedis if true then it's available
